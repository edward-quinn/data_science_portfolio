...
How many missing values do we have across our columns now?
...
Some columns have very few missing values, such as `Glucose`, while others, such as `Insulin` have a very high proportion of missing values. Predictors typically cannot have missing values in machine learning applications, so we will need to estimate what these missing values in our analysis pipeline.
